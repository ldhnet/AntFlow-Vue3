<template>
  <div class="page">
    <header class="page__header">
      ...
      <el-button size="small" class="publish-btn" @click="publish"
        >发布</el-button
      >
    </header>
    ...
    <!-- <div class="github">
      <el-tooltip effect="dark" content="前往Github" placement="top">
        <a href="https://github.com/ldhnet/antFlow" target="_blank" style="display: block;" rel="noopener noreferrer">
...
export default {
  ...
  mounted() {
    GET_MOCK_CONF()
      .then((c) => {
        this.configFormData = c.formData;
      })
      .finally((c) => {
        //初始化 流程节点 条件 类型
  ...
  methods: {
    ...
    onInitiatorConditionType() {
      this.configFormData.fields.forEach((t) => {
        setTimeout(() => {
